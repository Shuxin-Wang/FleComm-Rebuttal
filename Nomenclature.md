...
| $P(s' \vert s, \mathbf{a})$              | State transition probability function                        | $P(s'\vert s, \mathbf{a}): S \times \mathbf{A} \times S \rightarrow [0, 1]$ |
...
| $\mathcal{O}_{-i}^t$                     | Observations set of all agents except $i$ at time $t$        |                                                              |
| $\mathcal{O}_{\mathcal{K}}^t$            | Observations partial subset of agents selected for communication |                                                              |
